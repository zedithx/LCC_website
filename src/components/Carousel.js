                        ...
                        md:pl-10 md:mt-14 md:pb-24 pb-4 md:text-left text-center' data-aos='fade-right' data-aos-duration='800'>
                            ...
                            <div className='flex md:flex-row flex-col-reverse items-center mx-auto mt-4 gap-6 md:gap-10'>
                                <h1 className='font-gotham-light text-white md:text-[1.2vw] text-[4vw] md:w-6/12 w-10/12 text-left'>
                                    In this undergraduate research program, students analyze air cargo demand for Southeast Asia,
                                    utilizing IATA&apos;s CargoIS and macroeconomic datasets.
                                    They engage in data analysis, econometric testing, and visualizations using R and Python,
                                    examining trade policies and economic factors in ASEAN countries. This program
                                    offers a comprehensive research experience, ideal for students keen on exploring complex
                                    economic trends and their impact on regional trade dynamics.
                                </h1>
                         ...
                         data-aos={`${(this.state.previousSlide > 1) ? 'fade-right' : "fade-left"}`} data-aos-duration='800'>
                            ...
                            <div className='flex md:flex-row flex-col-reverse items-center mx-auto mt-4 md:gap-10 gap-6'>
                                <h1 className='font-gotham-light text-white md:text-[1.5vw] text-[4vw] md:w-6/12 w-10/12 text-left md:mt-10'>
                                    Embark on an exhilarating journey at UC Berkeley&apos;s Global Experience,
                                    where you&apos;ll delve into environmental science, game theory, and neurodiversity.
                                    Capture life through digital photography, explore nature&apos;s wonders, and immerse
                                    yourself in the vibrant culture and history of San Francisco, all while embracing the
                                    dynamic Berkeley lifestyle.
                                </h1>
